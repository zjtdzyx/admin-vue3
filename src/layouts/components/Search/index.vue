...
const searchResultRef
  = useTemplateRef<OverlayScrollbarsComponentRef>('searchResultRef')
  ...
  <TransitionRoot as="template" :show="isShow">
    ...
    >
      ...
      <div class="fixed inset-0">
        <div
          class="h-full flex items-end justify-center p-4 text-center lg-items-center"
        >
            ...
            >
              ...
              >
                <div
                  ...
                  border-b="~ solid stone-2 dark-stone-7"
                >
                  ...
                  >
                    <template v-if="resultList.length > 0">
                      <a
                        ...
                        :class="{
                          'bg-stone-2/40 dark-bg-stone-7/40': index === actived,
                        }"
                        :data-index="index"
                      ...
                      >
                        <SvgIcon
                          ...
                          :class="{
                            'scale-120 text-ui-primary': index === actived,
                          }"
                        />
                        <div
                ...
                >
                  <div class="flex gap-8">
                    ...
                    <div class="inline-flex items-center gap-1 text-xs">
                      <HKbd>
                        <SvgIcon
                          name="i-ant-design:caret-up-filled"
                          :size="14"
                        />
                      </HKbd>
                      <HKbd>
                        <SvgIcon
                          name="i-ant-design:caret-down-filled"
                          :size="14"
                        />
                      </HKbd>
                      <span>切换</span>
