  ...
  >
    <div class="w-full inline-flex">
      ...
      >
        ...
        <span
          class="pointer-events-none absolute end-0 inset-y-0 flex items-center pe-2.5"
        >
          <SvgIcon
            name="i-carbon:chevron-down"
            class="h-5 w-5 flex-shrink-0 text-stone-5"
          />
        </span>
      </button>
    </div>
    <template #popper>
      <div
        class="max-h-60 w-full scroll-py-1 overflow-y-auto p-1 lg-w-48 focus-outline-none"
      >
        <button
