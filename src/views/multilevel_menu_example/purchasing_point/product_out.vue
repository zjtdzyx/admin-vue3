...
// 模拟的初始数据
const originalData = [
  { productNumber: 'P001', name: '产品一', grade: 'A', origin: '中国', costPrice: 100, packaging: '盒', quantity: 50 },
  { productNumber: 'P002', name: '产品二', grade: 'B', origin: '美国', costPrice: 200, packaging: '袋', quantity: 30 },
  { productNumber: 'P003', name: '产品三', grade: 'A', origin: '日本', costPrice: 300, packaging: '瓶', quantity: 40 },
  { productNumber: 'P004', name: '产品四', grade: 'C', origin: '德国', costPrice: 400, packaging: '盒', quantity: 60 },
  { productNumber: 'P005', name: '产品五', grade: 'A', origin: '法国', costPrice: 500, packaging: '袋', quantity: 20 },
  { productNumber: 'P006', name: '产品六', grade: 'B', origin: '英国', costPrice: 600, packaging: '瓶', quantity: 70 },
  { productNumber: 'P007', name: '产品七', grade: 'C', origin: '意大利', costPrice: 700, packaging: '盒', quantity: 10 },
  { productNumber: 'P008', name: '产品八', grade: 'A', origin: '西班牙', costPrice: 800, packaging: '袋', quantity: 80 },
  { productNumber: 'P009', name: '产品九', grade: 'B', origin: '澳大利亚', costPrice: 900, packaging: '瓶', quantity: 90 },
  { productNumber: 'P010', name: '产品十', grade: 'C', origin: '加拿大', costPrice: 1000, packaging: '盒', quantity: 100 },
]
...
async function onSubmit() {
  ...
  if (!product) {
    ElMessageBox.alert('未找到对应的产品编号，请检查后再试。', '错误', {
  ...
  if (form.quantity <= 0 || form.quantity > product.quantity) {
    ElMessageBox.alert('非法的出库数量，请检查输入的数量。', '错误', {
      confirmButtonText: 'OK',
      type: 'error',
    })
    return
  ...
  try {
    product.quantity -= form.quantity // 更新产品库存数量
    saveToLocalStorage() // 保存到本地存储
    fetchTableData() // 更新表格数据
    ElMessageBox.alert('出库操作成功！', '成功', {
      confirmButtonText: 'OK',
      type: 'success',
    })
  } catch (err: any) {
